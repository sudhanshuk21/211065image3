...
img = cv2.imread('gutters1.jpg',0)
img = cv2.resize(img,(620, 843))
...
th3 = cv2.adaptiveThreshold(img, 240, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 11, 10); #adaptive
